...
class ScienceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        questionTextView.text = "What is the chemical symbol for water?"
        val answerOptions = arrayOf("H2O", "CO2", "O2", "N2")
        ...
        submitButton.setOnClickListener {
            ...
            if (selectedOption != -1) {
                ...
                if (answer.text == "H2O") {
                    ...
                    questionTextView.text = "Wrong! The correct answer is H2O."
                }
            }
        }
